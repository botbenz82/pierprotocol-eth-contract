...
contract Pier is ERC20, Ownable {
    ...
    constructor() ERC20("PIER PROTOCOL", unicode"PIER") Ownable(msg.sender) {
        ...
        maxTransaction = 1500 * 1e18; // 0.15% from total supply maxTransactionTxn
        maxWallet = 3000 * 1e18; // 0.3% from total supply maxWallet
        ...
        marketingWallet = address(0xFa88700a9bA56aFE71063e00D2De69d22d2C7AfB);
        developmentWallet = address(0xFa88700a9bA56aFE71063e00D2De69d22d2C7AfB);
